...
----
dependencies {
    griffon '{project-group}:griffon-weathericons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-weathericons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-weathericons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-weathericons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-weathericons-javafx-groovy:{project-version}'
}
----

== Maven

First configure the `griffon-weathericons-plugin` BOM in your POM file, by placing the following
